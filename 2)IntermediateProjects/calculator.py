...
class Application(Frame):
	...
	def create_widgets(self):
		...
		text = "+", padx = 33, pady = 20, font = ("Helvetica", 20 , "bold"),
	...
	def CalculateTask(self):
		...
		try:
			...
			self.displayText("InvalidSyntax!")
			self.task = ""
