...
labell=Label(Multiply,text='Multiplication Timetable', font=30,fg='Black').grid(row=1,column=6)
labell=Label(Multiply, text='                                         ').grid(row=2,column=6)
entry5=Entry(Multiply,textvariable=EnterTable,justify='center').grid(row=3,column=6)
labell=Label(Multiply,text='                                       ').grid(row=4,column=6)

button1 = Button(Multiply,text='Times Table', command=TimesTable).grid(row=5,column=6)
labell=Label(Multiply,text='                                        ').grid(row=6,column=6)
